...
foreach ($m in $modelFiles) {
    ...
    Write-Host "Downloading $filename -> $filepath"
    # gdown will attempt to find file by name in folder; this is a best-effort approach
    # In production, you'd use specific file IDs
...
if (Test-Path "11f_gsqnwHH1Iq9WUzKZNqF8IJ3pRWoeR") {
    Write-Host "Organizing files into models/ subdirectories..."
    $dlFolder = "11f_gsqnwHH1Iq9WUzKZNqF8IJ3pRWoeR"
